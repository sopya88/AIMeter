...
export const licenses: License[] = [
  { id: "l1",  employee: "Arjun Sharma",    email: "arjun.sharma@corp.in",    department: "Engineering",       role: "Engineering Manager",   licenseType: "GitHub Copilot",             status: "active",   lastUsed: "2024-06-14", monthlySpendINR: 19,  allocatedDate: "2024-01-01", unusedDays: 0,  requestsMonth: 1842, activeDays: 20 },
  { id: "l2",  employee: "Riya Desai",      email: "riya.desai@corp.in",      department: "Engineering",       role: "Senior SDE",            licenseType: "GitHub Copilot",             status: "active",   lastUsed: "2024-06-14", monthlySpendINR: 19,  allocatedDate: "2024-01-01", unusedDays: 0,  requestsMonth: 1456, activeDays: 18 },
  { id: "l3",  employee: "Karan Joshi",     email: "karan.joshi@corp.in",     department: "Engineering",       role: "SDE",                   licenseType: "GitHub Copilot",             status: "unused",   lastUsed: "2024-04-22", monthlySpendINR: 19,  allocatedDate: "2024-02-01", unusedDays: 53, requestsMonth: 8,    activeDays: 2  },
  { id: "l4",  employee: "Priya Mehta",     email: "priya.mehta@corp.in",     department: "Product & Design",  role: "Product Manager",       licenseType: "Microsoft 365 Copilot",     status: "active",   lastUsed: "2024-06-13", monthlySpendINR: 28,  allocatedDate: "2024-01-15", unusedDays: 0,  requestsMonth: 284,  activeDays: 19 },
  { id: "l5",  employee: "Neha Kulkarni",   email: "neha.kulkarni@corp.in",   department: "Product & Design",  role: "UX Designer",           licenseType: "Claude for Work",           status: "active",   lastUsed: "2024-06-12", monthlySpendINR: 19,  allocatedDate: "2024-03-01", unusedDays: 0,  requestsMonth: 612,  activeDays: 17 },
  { id: "l6",  employee: "Rahul Gupta",     email: "rahul.gupta@corp.in",     department: "Data Science",      role: "Head of Data Science",  licenseType: "Gemini Advanced",           status: "active",   lastUsed: "2024-06-14", monthlySpendINR: 19,  allocatedDate: "2024-01-01", unusedDays: 0,  requestsMonth: 438,  activeDays: 21 },
  { id: "l7",  employee: "Suresh Kumar",    email: "suresh.kumar@corp.in",    department: "Data Science",      role: "Data Scientist",        licenseType: "OpenAI ChatGPT Enterprise", status: "active",   lastUsed: "2024-06-11", monthlySpendINR: 23,  allocatedDate: "2024-02-15", unusedDays: 0,  requestsMonth: 820,  activeDays: 16 },
  { id: "l8",  employee: "Meena Iyer",      email: "meena.iyer@corp.in",      department: "Data Science",      role: "ML Engineer",           licenseType: "GitHub Copilot",             status: "unused",   lastUsed: "2024-05-01", monthlySpendINR: 19,  allocatedDate: "2024-02-01", unusedDays: 44, requestsMonth: 12,   activeDays: 3  },
  { id: "l9",  employee: "Anjali Singh",    email: "anjali.singh@corp.in",    department: "Sales & Marketing", role: "VP Sales",              licenseType: "Microsoft 365 Copilot",     status: "active",   lastUsed: "2024-06-14", monthlySpendINR: 28,  allocatedDate: "2024-01-01", unusedDays: 0,  requestsMonth: 341,  activeDays: 22 },
  { id: "l10", employee: "Rohit Verma",     email: "rohit.verma@corp.in",     department: "Sales & Marketing", role: "Sales Executive",       licenseType: "Microsoft 365 Copilot",     status: "inactive", lastUsed: "2024-03-10", monthlySpendINR: 28,  allocatedDate: "2024-01-15", unusedDays: 96, requestsMonth: 0,    activeDays: 0  },
  { id: "l11", employee: "Vikram Nair",     email: "vikram.nair@corp.in",     department: "Finance & Legal",   role: "CFO",                   licenseType: "Claude for Work",           status: "active",   lastUsed: "2024-06-13", monthlySpendINR: 19,  allocatedDate: "2024-03-01", unusedDays: 0,  requestsMonth: 389,  activeDays: 14 },
  { id: "l12", employee: "Sneha Patil",     email: "sneha.patil@corp.in",     department: "Customer Success",  role: "CS Manager",            licenseType: "OpenAI ChatGPT Enterprise", status: "active",   lastUsed: "2024-06-14", monthlySpendINR: 23,  allocatedDate: "2024-01-01", unusedDays: 0,  requestsMonth: 964,  activeDays: 18 },
  { id: "l13", employee: "Aditya Rao",      email: "aditya.rao@corp.in",      department: "Engineering",       role: "DevOps Engineer",       licenseType: "GitHub Copilot",             status: "pending",  lastUsed: null,          monthlySpendINR: 19,  allocatedDate: "2024-06-10", unusedDays: 0,  requestsMonth: 0,    activeDays: 0  },
  { id: "l14", employee: "Divya Krishnan",  email: "divya.krishnan@corp.in",  department: "Data Science",      role: "Data Analyst",          licenseType: "Gemini Advanced",           status: "unused",   lastUsed: "2024-04-30", monthlySpendINR: 19,  allocatedDate: "2024-02-01", unusedDays: 45, requestsMonth: 21,   activeDays: 4  },
];
