    ...
    setAlerts((a) => [
      {
        ...
        message: `${form.type === "budget" ? `Budget threshold ${form.threshold}% reached` : `${form.type.replace("_", " ")} alert at ${form.threshold}%`}`,
  ...
  return (
    <div className="p-6 max-w-[900px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-semibold" style={{ color: "var(--text)" }}>Alerts</h1>
          <p className="text-sm mt-0.5" style={{ color: "var(--muted)" }}>Monitor budget, cost spikes & token anomalies</p>
        </div>
        ...
        {alerts.map((a) => {
          ...
          return (
            <div key={a.id} className="flex items-start gap-3 rounded-lg border p-4"
              ...
              <AlertTriangle size={16} style={{ color: s.text, marginTop: 1, flexShrink: 0 }} />
